        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur supports-[backdrop-filter]:bg-white/5">
          <div className="flex items-center justify-between px-4 py-3 sm:px-6">
            ...
            <nav className="hidden items-center gap-8 md:flex">
              ...
              <a href="#solutions" className="text-sm text-white/80 hover:text-white transition">Solutions</a>
              <a href="#about" className="text-sm text-white/80 hover:text-white transition">About</a>
              <a href="#contact" className="inline-flex items-center gap-2 rounded-lg bg-white text-slate-900 px-4 py-2 text-sm font-semibold shadow hover:shadow-lg transition">
          ...
          {open && (
            <div className="md:hidden border-t border-white/10 px-4 py-3 sm:px-6">
              <div className="grid gap-2">
                <a href="#services" className="rounded-lg px-3 py-2 text-white/80 hover:bg-white/10">Services</a>
                <a href="#solutions" className="rounded-lg px-3 py-2 text-white/80 hover:bg-white/10">Solutions</a>
                <a href="#about" className="rounded-lg px-3 py-2 text-white/80 hover:bg-white/10">About</a>
                <a href="#contact" className="rounded-lg px-3 py-2 text-slate-900 bg-white font-semibold flex items-center gap-2">
